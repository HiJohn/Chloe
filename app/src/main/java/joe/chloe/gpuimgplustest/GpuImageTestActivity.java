...
public class GpuImageTestActivity extends AppCompatActivity {
    ...
    public static final String LOG_TAG = "klayTps";
    public static final String PKG_PREFIX = "joe.chloe.gpuimgplustest.";
    ...
    public class DemoButton extends AppCompatButton implements View.OnClickListener {
        ...
        public void onClick(final View v) {
            ...
            Class cls;
            try {
                cls = Class.forName(PKG_PREFIX + mDemo.activityName);
            ...
            try {
                if (cls != null)
                    startActivity(new Intent(GpuImageTestActivity.this, cls));
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gpuimagetest);
